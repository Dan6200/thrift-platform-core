...
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Laptop Pro X')), (select order_id from orders where customer_id = 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22' and store_id = (select store_id from stores where vendor_id = 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11' LIMIT 1) LIMIT 1), 1, 1100.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Classic Leather Jacket')), (select order_id from orders where customer_id = 'd0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44' and store_id = (select store_id from stores where vendor_id = 'c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33' LIMIT 1) LIMIT 1), 1, 220.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Organic Skincare Kit')), (select order_id from orders where customer_id = 'f1eebc99-9c0b-4ef8-bb6d-6bb9bd380a66' and store_id = (select store_id from stores where vendor_id = 'e0eebc99-9c0b-4ef8-bb6d-6bb9bd380a55' LIMIT 1) LIMIT 1), 1, 80.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Curved Gaming Monitor')), (select order_id from orders where customer_id = '14eebc99-9c0b-4ef8-bb6d-6bb9bd380a99' and store_id = (select store_id from stores where vendor_id = 'a2eebc99-9c0b-4ef8-bb6d-6bb9bd380a77' LIMIT 1) LIMIT 1), 1, 280.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Evening Gown Elegant')), (select order_id from orders where customer_id = 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22' and store_id = (select store_id from stores where vendor_id = 'e3eebc99-9c0b-4ef8-bb6d-6bb9bd380a88' LIMIT 1) LIMIT 1), 1, 270.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Coffee Maker Drip')), (select order_id from orders where customer_id = 'd0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44' and store_id = (select store_id from stores where vendor_id = '45eebc99-9c0b-4ef8-bb6d-6bb9bd380b00' LIMIT 1) LIMIT 1), 1, 60.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Travel Backpack 40L')), (select order_id from orders where customer_id = 'f1eebc99-9c0b-4ef8-bb6d-6bb9bd380a66' and store_id = (select store_id from stores where vendor_id = '14eebc99-9c0b-4ef8-bb6d-6bb9bd380a99' LIMIT 1) LIMIT 1), 1, 70.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Hand-painted Ceramic Mug')), (select order_id from orders where customer_id = '14eebc99-9c0b-4ef8-bb6d-6bb9bd380a99' and store_id = (select store_id from stores where vendor_id = 'd0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44' LIMIT 1) LIMIT 1), 1, 20.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'High-Performance Gaming Laptop')), (select order_id from orders where customer_id = 'b0eebc99-9c0b-4ef8-bb6d-6bb9bd380a22' and store_id = (select store_id from stores where vendor_id = 'a2eebc99-9c0b-4ef8-bb6d-6bb9bd380a77' LIMIT 1) LIMIT 1), 1, 1650.00),
((select variant_id from product_variants where product_id = (select product_id from products where title = 'Women''s Denim Jeans')), (select order_id from orders where customer_id = 'd0eebc99-9c0b-4ef8-bb6d-6bb9bd380a44' and store_id = (select store_id from stores where vendor_id = '45eebc99-9c0b-4ef8-bb6d-6bb9bd380b00' LIMIT 1) LIMIT 1), 1, 50.00);
