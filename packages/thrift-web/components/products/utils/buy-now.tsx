  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="h-[3rem] text-base sm:text-md md:text-xl font-bold w-full border border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 flex-1 gap-2 sm:gap-4">
          Buy Now
