...
export const expectedDataAfterVariantAdditionAndUpdates: ProductRequestData[] =
  [
    {
      title:
        'Apple AirPods Pro (2nd Generation) Wireless Earbuds, Up to 2X More Active Noise Cancelling, Adaptive Transparency, Personalized Spatial Audio, MagSafe Charging Case, Bluetooth Headphones for iPhone',
      ...
      variants: [
        {
          sku: 'BOSE-QC45-WHT',
          quantity_available: 10,
          net_price: 225000, // TODO: Change this behavior. When base price has been updated. variants should too.
          options: [{ option_name: 'COLOR', value: 'WHITE SMOKE' }],
        },
        {
          sku: 'BOSE-QC45-BLK',
          quantity_available: 15,
          net_price: 225000, // Same thing here...
          options: [{ option_name: 'COLOR', value: 'TRIPLE BLACK' }],
        },
      ],
    },
      ...
      variants: [
        {
          sku: 'FIT-CHG5-BLK',
          quantity_available: 20,
          list_price: 89962.5, // TODO: Same issue
          net_price: 112500,
          options: [
            { option_name: 'COLOR', value: 'BLACK' },
            { option_name: 'BAND', value: 'S/L' },
