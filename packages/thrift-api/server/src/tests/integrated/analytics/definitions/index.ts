...
} from '#src/app-schema/analytics.js'

const { OK } = StatusCodes

const buildAnalyticsPath = (storeId: number, endpoint: string) =>
  `/v1/analytics/stores/${storeId}/${endpoint}`

export const testGetKPIs = (args: {
  token: string
  query: { storeId: number; startDate: string; endDate: string }
}) => {
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'kpis')
...
export const testGetRevenueTrends = (args: {
  ...
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'revenue-trends')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetSalesAnalytics = (args: {
  ...
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'sales-analytics')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetCustomerAcquisitionTrends = (args: {
  ...
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'customer-acquisition-trends')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetCustomersByLocation = (args: {
  token: string
  query: { storeId: number; locationType: string }
}) => {
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'customers-by-location')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetCustomerLifetimeValue = (args: {
  token: string
  query: { storeId: number; limit: number; sortBy: string; sortOrder: string }
}) => {
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'customer-lifetime-value')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetTopSellingProducts = (args: {
  token: string
  query: { storeId: number; startDate: string; endDate: string; limit: number }
}) => {
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'top-selling-products')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetLowStockProducts = (args: {
  token: string
  query: { storeId: number; threshold: number; limit: number }
}) => {
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'low-stock-products')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
...
export const testGetProductPerformance = (args: {
  ...
  const { storeId, ...query } = args.query
  const path = buildAnalyticsPath(storeId, 'product-performance')
  const requestParams: RequestParams = {
    token: args.token,
    query,
  }
